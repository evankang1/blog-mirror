...
# GitHub Pages URL - user will replace username
GITHUB_PAGES_BASE = f"https://kevin-story2009.github.io/blog-mirror/"  # will be replaced by user
# Fallback: use relative sitemap with actual domain after deploy
...
def main():
    ...
    # Determine base URL for sitemap: try env var
    base_url = os.environ.get("PAGES_BASE_URL") or "https://example.github.io/blog-mirror/"
    # If running locally, keep example, user will replace later
    # Write files
